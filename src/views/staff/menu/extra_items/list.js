              ...
              <tr {...row.getRowProps()}>
                ...
                {(() => {
                  if (permission==="3") {
                    return(
                      <td>
                        <NavLink to={`/staff/menu/extra_items/update/${row.original.id}`} className="btn btn-primary">Edit</NavLink>{" "}
                    ...
                    return(
                      <td>
                        <NavLink to={`/staff/menu/extra_items/view/${row.original.id}`} className="btn btn-primary">View</NavLink>{" "}
                      </td>
                    )
                  }
                })()}
            ...
            <Card className="mb-4">
              <CardBody>
                <Row>
                  <Colxx xxs="10">
                    <CardTitle>
                      <i className="iconsminds-align-justify-all"></i>&nbsp;&nbsp;Extra Items List
                    </CardTitle>
                  </Colxx>
                </Row>
