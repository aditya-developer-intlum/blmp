              ...
              <tr {...row.getRowProps()}>
                ...
                {(() => {
                  if (permission==="3") {
                    return(
                      <td>
                        <NavLink to={`/staff/menu/toppings_group/update/${row.original.id}`} className="btn btn-primary">Edit</NavLink>{" "}
                    ...
                    return(
                      <td>
                        <NavLink to={`/staff/menu/toppings_group/view/${row.original.id}`} className="btn btn-primary">View</NavLink>{" "}
                      </td>
                    )
                  }
                })()}
