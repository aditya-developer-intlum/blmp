          ...
          {page.map((row) => {
            ...
            return (
              <tr {...row.getRowProps()}>
                ...
                <td>
                   <NavLink to={`/admin/vendor/update/${row.original.id}`} className="btn btn-primary">Edit</NavLink>{" "}
            ...
            <Card className="mb-4">
              <CardBody>
                <Row>
                  <Colxx xxs="10">
                    <CardTitle>
                      <i className="iconsminds-align-justify-all"></i>&nbsp;&nbsp;Vendor List
                    </CardTitle>
                  </Colxx>
                  <Colxx xxs="2">
                    <CardTitle>
                      <NavLink to={`/${localStorage.getItem('user_type')}/vendor/create`} className="btn btn-success">Create</NavLink>
                    </CardTitle>
                  </Colxx>
                </Row>
