...
class DeliveryStaffUpdate extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      form: {
            ...
            <Card className="mb-4">
              <CardBody>
                <Row className="mb-2">
                  <Colxx xxs="10">
                    <CardTitle>
                      <i className="iconsminds-add-user"></i>&nbsp;&nbsp;Update Delivery Staff
                    </CardTitle>
                  </Colxx>
                </Row>
                <RegisterForm loading={this.props.loading} activeTab={activeTab} mode={'update'} formFields={form}
...
export default DeliveryStaffUpdate;
