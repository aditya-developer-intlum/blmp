                                ...
                                <Col sm="12">
                                    ...
                                    <FormGroup className="form-group mt-2">
                                        <Row>
                                            ...
                                            <Col sm="1">
                                                <Field type="checkbox" name="breakfast" className="form-control"></Field>
                                            </Col>
                                            <Col sm="1">
                                                <Label>Breakfast</Label>
                                            </Col>
                                            <Col sm="1">
                                                <Field type="checkbox" name="lunch" className="form-control"></Field>
                                            </Col>
                                            <Col sm="1">
                                                <Label>Lunch</Label>
                                            </Col>
                                            <Col sm="12"></Col>
                                            <Col sm="1">
                                                <Field type="checkbox" name="dinner" className="form-control"></Field>
                                            </Col>
                                            <Col sm="1">
                                                <Label>Dinner</Label>
                                            </Col>
                                            <Col sm="1">
                                                <Field type="checkbox" name="snacks" className="form-control"></Field>
                                            </Col>
                                            <Col sm="1">
                                                <Label>Snacks</Label>
                                            </Col>
                                            <Col sm="12"></Col>
                                            <Col sm="1">
                                                <Field type="checkbox" name="all_time_menu" className="form-control"></Field>
                                            </Col>
                                            <Col sm="2">
