...
export const MenuItemForm = ({ formFields, onRegister, loading, mode, menu_group_list, toggleUpload, handleChange }) => {
                                    ...
                                    <Row>
                                        <Col sm="12">
                                            <FormGroup className="form-group has-float-label">
                                                ...
                                                <Field as="select" name="menu_group" className="form-control" required>
                                                        ...
                                                        {formFields.price.map((pval, index) => (
                                                            <Row className="mt-1" key={`row_${index}`}>
                                                                ...
                                                                <Col sm="7" className="mb-1"  key={`price_col_${index}`}>
                                                                    <Field key={index} className="form-control" name={`price[${index}].price`} required/>
                                                                    {/* {(() => {
                                                            ...
                                                            <Col sm="6" key={`main_col_${index}`}>
                                                                <Row className="mt-1" key={`row_${index}`}>
                                                                    ...
                                                                    <Col sm="3" className="mb-1"  key={`extra_col_${index}`}>
                                                                        <Field key={index} type="checkbox" className="form-control" name={`extra[${index}].status`} />
                                                                    </Col>
                                                                </Row>
                                                            </Col>
                                                        ))}
                                    ...
                                    <Row className="mt-4">
                                        <Col sm="6">
                                            <FormGroup className="form-group has-float-label">
                                                ...
                                                <Field as="select" name="spicy" className="form-control" required>
                                                    <option value="">Select</option>
                                        ...
                                        <Col sm="6">
                                            <FormGroup className="form-group has-float-label">
                                                ...
                                                <Field as="select" name="veg_status" className="form-control" required>
                                                    <option value="">Select</option>
                                    ...
                                    <Row>
                                        <Col sm="6">
                                            <FormGroup className="form-group has-float-label">
                                                ...
                                                <Field as="select" name="status" className="form-control" required>
                                                    <option value="">Select</option>
