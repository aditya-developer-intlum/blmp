...
import menuItems from '../../constants/restaurantMenu';
...
class Sidebar extends Component {
  ...
  getLink = (index, route) => {
    if (index > 0) {
      return route + '/' + this.state.restaurantId;
    } else {
      return route;
    }
  };
                              ...
                              {sub.newWindow ? (
                                ...
                                <>
                                  ...
                                  >
                                          ...
                                          >
                                            {thirdSub.newWindow ? (
                                              ...
                                              >
                                                ...
                                                <NavLink to={thirdSub.to + '/' + this.state.restaurantId}>
                                                  <i className={thirdSub.icon} />{' '}
                                                  {thirdSub.label}
                                    ...
                                    <NavLink to={sub.to + '/' + this.state.restaurantId}>
                                      <i className={sub.icon} />{' '}
                                      {sub.label}
                                    </NavLink>
                                  )}
